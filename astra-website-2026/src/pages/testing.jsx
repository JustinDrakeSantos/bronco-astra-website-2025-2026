...
const testFlights = [
  { id: 1, date: "March 30, 2026", 
    tested: "First Test Flight with Sentinel", 
    videoId: "4_eZP47MgGU", 
    detailsUrl: "/test-flights/1",
    details: "This was Bronco ASTRA's first test flight with the Sentinel Hexacopter. It was conducted in an open soccer field and nobody was holding the YAGI. The flight's operating range was 50-90 Amps with peak only being reached during yaw maneuvers. It was concluded that the Amp sensor may be off about +1 to +1.5 amps [as per video]. Operating volts reached a low of 22.9V and the weakest signal strength was 72%. "
  },
  { id: 2, 
    date: "March 31, 2026", 
    tested: "Comp Entry", 
    ...
    details: "This was Bronco ASTRA's flight readiness test for the 2026 SUAS Competition. The flight was a success and therefore deemed sufficient to submit for competition entry."
  },
  { id: 3, 
    date: "April 11, 2026", 
    tested: "Limit Test", 
  ...
  {id: 4, 
    ...
    details: "Originally we wanted to test both a Payload drop and an Object Recognition test along with a No_YAW mission, but both were abandoned due to some technical difficulties. Overall for the No_YAW test, it was a success and Sentinel was tested in a Loiter test with different flight modes."
  },
  {id: 5, 
    date: "April 22, 2026", 
          ...
          {testFlights.map((flight) => (
            <article className="flight-card" key={flight.id}>
              ...
              <div className="flight-info">
                ...
                <button className="details-link" onClick= {() => setSelectedFlight(flight)}>
